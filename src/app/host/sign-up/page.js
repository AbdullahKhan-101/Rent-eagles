...
const Index = () => {
  ...
  const onSubmit = async (formData) => {
    ...
    try {
      const response = await API.SignUpHost(formData);
  ...
  return (
    <div className="max-w-[80%] lg:max-w-[40%] mx-auto pb-14">
      <h1 className="text-center my-12">Host Sign-Up</h1>

      <form
        className="flex  justify-center flex-col items-start gap-6 w-full mt-12"
      ...
      <div className="pt-2 text-right">
        <Link href="/host/log-in" className="text-[#99000B] mx-auto ">
